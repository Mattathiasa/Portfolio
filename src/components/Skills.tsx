...
export const Skills = () => {
  ...
  return (
    <section id="skills" ref={ref} className="py-24 relative bg-gradient-to-b from-background to-[hsl(var(--gradient-mid))]">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              {tools.map((tool, index) => (
                <motion.div
                  ...
                  className="glass-card p-4 rounded-lg text-center transition-smooth hover:scale-105 hover:glow-accent"
                >
              ...
              <div className="space-y-4">
                {achievements.map((achievement, index) => (
                  <motion.div
                    ...
                    className="glass-card p-4 rounded-lg flex items-center gap-4 transition-smooth hover:glow-accent"
                  >
                    <achievement.icon className="w-10 h-10 text-accent flex-shrink-0" />
                    <div>
