      ...
      <div className="container mx-auto px-4">
        ...
        >
          {stats.map((stat, index) => (
            <div
              key={index}
              className="glass-card p-6 rounded-xl text-center transition-smooth hover:scale-105"
            >
        ...
        >
          {highlights.map((item, index) => (
            <div
              key={index}
              className="glass-card p-6 rounded-xl transition-smooth hover:scale-105 hover:glow-accent"
            >
